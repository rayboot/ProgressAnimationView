 ...
 * @TODO
 */
public class ProgressCircularDrawable extends Drawable implements Animatable
{
    ...
    public ProgressCircularDrawable(int color, float borderWidth)
    {
    ...
    private Property<ProgressCircularDrawable, Float> mAngleProperty =
            new Property<ProgressCircularDrawable, Float>(Float.class, "angle")
            {
                @Override
                public Float get(ProgressCircularDrawable object)
                {
                    return object.getCurrentGlobalAngle();
                }

                @Override
                public void set(ProgressCircularDrawable object, Float value)
                {
                    object.setCurrentGlobalAngle(value);
                }
            };

    private Property<ProgressCircularDrawable, Float> mSweepProperty =
            new Property<ProgressCircularDrawable, Float>(Float.class, "arc")
            {
                @Override
                public Float get(ProgressCircularDrawable object)
                {
    ...
    {
        mObjectAnimatorAngle =
                ObjectAnimator.ofFloat(this, mAngleProperty, 360f);
